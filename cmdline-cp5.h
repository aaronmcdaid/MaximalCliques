...
#ifndef CMDLINE_CP5_H
#define CMDLINE_CP5_H
...
#define CMDLINE_PARSER_PACKAGE "Clique Percolation 5th variant"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "Clique Percolation 5th variant"
#endif
...
struct gengetopt_args_info
{
  ...
  int K_arg;	/**< @brief max k of interest. default is to do all k.     (default='-1').  */
  char * K_orig;	/**< @brief max k of interest. default is to do all k.     original value given at command line.  */
  const char *K_help; /**< @brief max k of interest. default is to do all k.     help description.  */
