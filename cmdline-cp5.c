/*
  ...
  gengetopt --unamed-opts -F cmdline-cp5 
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVk:K:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'k':	/* minimum size of clique, k. Must be at least 3..  */
          ...
          break;
        case 'K':	/* max k of interest. default is to do all k.    .  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* rebuild bloom filter occasionally.  */
          else if (strcmp (long_options[option_index].name, "rebuild.bloom") == 0)
          {
