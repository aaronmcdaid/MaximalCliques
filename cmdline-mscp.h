...
#ifndef CMDLINE_MSCP_H
#define CMDLINE_MSCP_H
...
#define CMDLINE_PARSER_PACKAGE "mSCP"
#endif
...
struct gengetopt_args_info
{
  ...
  int k_arg;	/**< @brief size of clique to percolate. Must be at least 3. (default='3').  */
  char * k_orig;	/**< @brief size of clique to percolate. Must be at least 3. original value given at command line.  */
  const char *k_help; /**< @brief size of clique to percolate. Must be at least 3. help description.  */
