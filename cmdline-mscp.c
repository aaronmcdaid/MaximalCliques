/*
  ...
  gengetopt --unamed-opts -F cmdline-mscp 
...
const char *gengetopt_args_info_purpose = "A C++ implementation of Sequential Clique Percolation (SCP)";

const char *gengetopt_args_info_usage = "Usage: Usage: mscp [OPTIONS]... edge_list output_file";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -k, --k=INT      size of clique to percolate. Must be at least 3.  \n                     (default=`3')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->comments_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'k':	/* size of clique to percolate. Must be at least 3..  */
